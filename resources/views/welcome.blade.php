      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="scroll"><a href="#blog">เข้าสู่ระบบ</a></li>
        ...
        <div class="row">
          <div class="col-sm-3">
            <div class="team-member wow flipInY" data-wow-duration="1000ms" data-wow-delay="300ms">
              <div class="member-image">
                <img class="img-responsive" src="{{url('images/team/1.jpg')}}" alt="">
              </div>
          ...
          <div class="col-sm-3">
            <div class="team-member wow flipInY" data-wow-duration="1000ms" data-wow-delay="500ms">
              <div class="member-image">
                <img class="img-responsive" src="{{url('images/team/2.jpg')}}" alt="">
              </div>
              <div class="member-info">
                <h3>Lawrence Lane</h3>
          ...
          <div class="col-sm-3">
            <div class="team-member wow flipInY" data-wow-duration="1000ms" data-wow-delay="800ms">
              <div class="member-image">
                <img class="img-responsive" src="{{url('images/team/3.jpg')}}" alt="">
              </div>
              <div class="member-info">
                <h3>Lois Clark</h3>
                <h4>Developer</h4>
          ...
          <div class="col-sm-3">
            <div class="team-member wow flipInY" data-wow-duration="1000ms" data-wow-delay="1100ms">
              <div class="member-image">
                <img class="img-responsive" src="{{url('images/team/4.jpg')}}" alt="">
              </div>
              <div class="member-info">
                <h3>Marian Dixon</h3>
        ...
        <div class="row">
          <div class="col-sm-4 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">
            <div class="post-thumb">
              <a href="#"><img class="img-responsive" src="{{url('images/blog/1.jpg')}}" alt=""></a>
              <div class="post-meta">
              ...
              <div id="post-carousel"  class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="item active">
                    <a href="#"><img class="img-responsive" src="{{url('images/blog/2.jpg')}}" alt=""></a>
                  </div>
                  <div class="item">
                    <a href="#"><img class="img-responsive" src="{{url('images/blog/1.jpg')}}" alt=""></a>
                  </div>
                  <div class="item">
                    <a href="#"><img class="img-responsive" src="{{url('images/blog/3.jpg')}}" alt=""></a>
                  </div>
                </div>
